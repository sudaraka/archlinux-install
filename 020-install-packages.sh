...
BASE_PKG='base base-devel syslinux wireless_tools wpa_supplicant gvim sudo yaourt rsync wget git nfs-utils ntp bc haveged truecrypt openssh rfkill bash-completion';
