...
BASE_PKG='base base-devel syslinux wireless_tools wpa_supplicant gvim sudo yaourt rsync wget git nfs-utils ntp bc haveged openssh rfkill bash-completion alsa-utils alsa-oss alsa-plugins fuse wxgtk2.8';
